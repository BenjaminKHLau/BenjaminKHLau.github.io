...
function About() {
  ...
  return (
    <div id="about">
      <h1>Hello! I am currently refactoring my portfolio from scratch! I believe that this is a good opportunity to sharpen my skills and rely less on premade templates! Thank you for your patience. Last updated April 14, 2023</h1>
      <h1>About Me</h1>
      <div className="about">
